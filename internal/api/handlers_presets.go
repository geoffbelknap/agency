...
func (h *handler) createPreset(w http.ResponseWriter, r *http.Request) {
	...
	h.audit.WriteSystem("preset_created", map[string]interface{}{"preset": body.Name})
...
func (h *handler) updatePreset(w http.ResponseWriter, r *http.Request) {
	...
	h.audit.WriteSystem("preset_updated", map[string]interface{}{"preset": name})
...
func (h *handler) deletePreset(w http.ResponseWriter, r *http.Request) {
	...
	h.audit.WriteSystem("preset_deleted", map[string]interface{}{"preset": name})
