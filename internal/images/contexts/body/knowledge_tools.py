...
def _validate_kind(kind: str) -> str:
    ...
    # Common aliases
    aliases = {
        "agent": "system", "application": "system", "app": "system",
...
def register_knowledge_tools(registry, knowledge_url: str, agent_name: str, active_mission: dict | None = None) -> None:
...
def _contribute_knowledge(base_url: str, agent_name: str, args: dict, active_mission: dict | None = None) -> str:
    try:
