...
def read_context_fallback(context_file: Path) -> dict | None:
...
class WSListener:
    ...
    Usage::
        ...
        listener = WSListener(
            comms_url="http://agency-comms:8080",
            agent_name="scout",
            event_queue=q,
    ...
    def __init__(
        ...
        self._last_connected_at: str | None = None  # ISO timestamp of last successful connection
    ...
    async def _connect_loop(self) -> None:
        ...
        attempt = 0
        disconnect_at: str | None = None  # ISO timestamp when we lost connection
