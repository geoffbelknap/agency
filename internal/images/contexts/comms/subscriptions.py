...
from agency_core.models.subscriptions import ExpertiseDeclaration, ExpertiseTier, InterestDeclaration
...
class SubscriptionManager:
    ...
    def clear_expertise(self, agent_name: str, tier: str | None = None) -> None:
    ...
    def get(self, agent_name: str) -> InterestDeclaration | None:
