...
class ComponentLimits(BaseModel):
    ...
    def shared_infra_mb(self) -> int:
        """Total memory for shared infrastructure (egress + analysis + comms + swarm vault)."""
        return (
            self.egress_mem_mb + self.analysis_mem_mb + self.comms_mem_mb
...
class HostProfile(BaseModel):
    ...
    def apply_baselines(self) -> None:
        ...
        mapping = {
            ...
            "agentsh-server": ("gateway_mem_mb", limits.gateway_headroom),
