...
Body: provider-native batch request generated by the provider adapter.
...
```json
{"type": "LLM_BATCH_SUBMIT", "source": "knowledge-synthesizer", "batch_id": "batch_abc", "model": "fast", "request_count": 1}
