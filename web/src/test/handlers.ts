...
export const handlers = [
  ...
  http.delete(`${BASE}/agents/:name/cache`, () => HttpResponse.json({ deleted: 0 })),
  http.get(`${BASE}/agents/:name/economics`, () => HttpResponse.json({
    agent: 'test',
    period: '2026-04-09',
    total_cost_usd: 0,
    requests: 0,
  ...
  http.get(`${BASE}/agents/economics/summary`, () => HttpResponse.json({
    period: '2026-04-09',
    total_cost_usd: 0,
    requests: 0,
    by_agent: {},
  ...
  http.get(`${BASE}/graph/memory/proposals`, () => HttpResponse.json({ items: [] })),
  http.post(`${BASE}/graph/memory/proposals/:id/review`, () => HttpResponse.json({ ok: true })),
