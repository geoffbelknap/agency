        ...
        {editing ? (
          ...
          <>
            {message.isAgent ? (
              ...
              <div className="text-sm text-foreground/80 prose prose-gray dark:prose-invert prose-sm max-w-none break-words prose-p:my-1 prose-table:text-xs prose-th:px-2 prose-th:py-1 prose-td:px-2 prose-td:py-1 prose-pre:bg-card prose-pre:text-xs">
