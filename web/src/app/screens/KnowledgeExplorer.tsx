    ...
    <div className="h-full flex flex-col">
      <div className="flex items-center justify-end gap-2 px-4 py-4 md:px-6">
        <Tabs value={view} onValueChange={(value) => setView(value as ViewMode)}>
          <TabsList>
            <TabsTrigger value="browser"><List data-icon="inline-start" />Browser</TabsTrigger>
            <TabsTrigger value="graph"><Network data-icon="inline-start" />Graph</TabsTrigger>
            <TabsTrigger value="search"><Search data-icon="inline-start" />Search</TabsTrigger>
          </TabsList>
        </Tabs>
        <Button
          size="sm"
      ...
      {view === 'browser' && (
        <Card className="mx-4 md:mx-6">
          <CardHeader>
            ...
            <CardDescription>Current node distribution by kind and source.</CardDescription>
          </CardHeader>
          <CardContent className="flex flex-wrap items-center gap-x-6 gap-y-1 overflow-hidden text-xs text-muted-foreground">
          <span>
