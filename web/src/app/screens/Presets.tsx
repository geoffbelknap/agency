          ...
          {!editing && !selected ? (
            ...
            <Card>
              <CardHeader>
                <div className="flex items-center justify-between">
                <div>
                  <CardTitle>{isNew ? 'New Preset' : `Edit: ${draft.name}`}</CardTitle>
                  <CardDescription>Standardize role behavior before assigning capabilities or shipping a custom agent path.</CardDescription>
                </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  ...
                  <Select value={draft.type} onValueChange={(value) => updateDraftField('type', value)}>
