    ...
    <div className="space-y-4">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        ...
        <div className="flex gap-2">
          ...
          >
            <RefreshCw className={refreshing || capacityLoading ? 'animate-spin' : ''} />
      ...
      <Card>
        <CardHeader>
          <CardTitle>Host capacity</CardTitle>
          <CardDescription>
            {showMeeseeks
        ...
        {capacityLoading ? (
          <CardContent className="px-4 py-6 text-sm text-muted-foreground text-center">Loading capacity...</CardContent>
        ) : capacityError ? (
          <CardContent className="px-4 py-4 text-sm text-amber-700 dark:text-amber-300 bg-amber-50 dark:bg-amber-950/20">
            {capacityError}
          </CardContent>
        ) : capacity && (
          <CardContent className="space-y-4">
            ...
            <Progress value={capacityPercent(capacity)} aria-label={`Capacity ${capacityPercent(capacity)}% used`} />
          </CardContent>
        )}
      </Card>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Runtime service state and safe recovery actions.</CardDescription>
        </CardHeader>
        <CardContent>
          <Table>
            <TableHeader>
            ...
            <TableBody>
              {loading ? (
                <TableRow>
                  <TableCell colSpan={4} className="p-4 text-center text-muted-foreground text-xs">Loading...</TableCell>
                </TableRow>
              ) : services.length === 0 ? (
                <TableRow>
                  <TableCell colSpan={4} className="p-8 text-center text-muted-foreground text-sm">
