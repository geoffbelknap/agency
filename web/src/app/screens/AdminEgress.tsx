              ...
              <TableBody>
                {egressDomains.map((entry: any) => (
                  <TableRow key={entry.domain}>
                    <TableCell className="font-mono text-xs text-foreground">{entry.domain}</TableCell>
                    <TableCell>
        ...
        {!egressData ? (
          ...
          <div className="mt-3 space-y-4">
            ...
            {(egressData.allowed_domains || egressData.domains) && (
              <Card>
                <CardHeader>
                  <CardTitle className="text-xs uppercase tracking-wide text-muted-foreground">Allowed Domains</CardTitle>
                </CardHeader>
                <CardContent>
