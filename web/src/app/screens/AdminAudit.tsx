    ...
    <div className="space-y-4">
      <Card>
        <CardHeader>
          ...
          <CardDescription>Filter, summarize, and export recorded agent and mediation activity.</CardDescription>
        </CardHeader>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Review the raw stream without leaving the admin surface.</CardDescription>
        </CardHeader>
