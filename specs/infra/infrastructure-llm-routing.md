...
Infrastructure containers reach the gateway via `http://gateway:8200` on the Docker mediation network (gateway socket proxy). See `specs/infra/gateway-socket-proxy.md`.
