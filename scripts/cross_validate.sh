#!/usr/bin/env bash
# scripts/cross_validate.sh — Run both Go and Python against shared fixtures.
# Usage: ./scripts/cross_validate.sh <model_name>
# Example: ./scripts/cross_validate.sh org

set -euo pipefail

MODEL="${1:?Usage: cross_validate.sh <model_name>}"
