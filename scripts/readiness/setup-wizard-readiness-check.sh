...
usage() {
  cat <<'EOF'
Usage: ./scripts/readiness/setup-wizard-readiness-check.sh [options]
...
"$ROOT_DIR/scripts/e2e/e2e-live-web.sh" --force-infra-up --skip-build --config "$AGENCY_PLAYWRIGHT_CONFIG"
